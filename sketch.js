...
function setup() {
  ...
  boundary_6 = new Boundary(width * 0.2, height * 0.31, width / 5, 1, PI / 3);
  boundary_7 = new Boundary(width * 0.8, height * 0.31, width / 5, 1, -PI / 3);
  boundary_8 = new Boundary(width * 0.24, height * 0.25, width / 6, 1, -PI / 6);
